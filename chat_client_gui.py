...
class ConnectFrame():
    def __init__(self, top):
        ...
        self.frame=Frame(self.top)
        self.frame.grid()
        self.lbl_title = Label(self.frame, text = "Welcome to MBTM Chat App", font = ("Arial Bold",20))
        self.lbl_title.grid(column = 0, row = 0, columnspan = 2, ipadx = 30)
 
        # self.lbl_name = Label(self.frame, text = "Name")
        # self.lbl_name.grid(column = 0, row = 1, sticky='W', pady = 20, padx = 3)
        # self.txt_name = Entry(self.frame, width = 15)
        # self.txt_name.grid(column = 1, row = 1, sticky='W', pady = 20)
